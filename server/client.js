...
async function sendNotificationList(socket) {
    ...
    let result = [];
    let list = await R.find("notification"); // shared admin workspace: all notifications visible
...
async function sendProxyList(socket) {
    ...
    const list = await R.find("proxy"); // shared admin workspace
...
async function sendDockerHostList(socket) {
    ...
    let result = [];
    let list = await R.find("docker_host"); // shared admin workspace
...
async function sendRemoteBrowserList(socket) {
    ...
    let result = [];
    let list = await R.find("remote_browser"); // shared admin workspace
